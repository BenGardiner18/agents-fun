...
class ImageMixin:
    ...
    def image(
        ...
        width: int | None = None,
        use_container_width: UseColumnWith = None,
        clamp: bool = False,
        ...
        *,
        ...
        if use_container_width is True and use_container_width is not None:
            raise StreamlitAPIException(
                "`use_container_width` and `use_container_width` cannot be set at the same time.",
                "Please utilize `use_container_width` since `use_container_width` is deprecated.",
            )
        ...
        if use_container_width is not None:
            show_deprecation_warning(
                "The `use_container_width` parameter has been deprecated and will be removed "
                "in a future release. Please utilize the `use_container_width` parameter instead."
            )

            if use_container_width == "auto":
